...
while True:
    ...
    try:
        ...
        weight_query = "INSERT INTO multisensor VALUES (%s,%s,%s,%s)"

        # Hard code weight sensor as sensor 0
        weight_args = (0,tdate,ttime,weight)
    ...
    try:
        ...
        for sensornum in range(0,sensor_dir_len):
            ...
            try:
                query = "INSERT INTO multisensor VALUES (%s,%s,%s,%s)"
                args = (sensornum+1,tdate,ttime,temp)
